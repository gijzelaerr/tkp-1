...
def perform_forced_fits(fit_posns, fit_ids,
    ...
    Returns:
        list: A matched pair of lists (serialized_fits, ids), corresponding to
            successfully fitted positions. NB returned lists may be shorter
            than input lists if some fits are unsuccessful.
    """
